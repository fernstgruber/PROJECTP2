...
<qgis version="2.6.1-Brighton" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="geolegende">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="geolegen_1">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="geolegen_2">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="geolegen_3">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="SGU_legend">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="geolegen_1" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="AD" label="AD"/>
      <category render="true" symbol="1" value="Ant" label="Ant"/>
      <category render="true" symbol="2" value="CBD" label="CBD"/>
      <category render="true" symbol="3" value="CD" label="CD"/>
      <category render="true" symbol="4" value="CSR" label="CSR"/>
      <category render="true" symbol="5" value="DC" label="DC"/>
      <category render="true" symbol="6" value="GLD" label="GLD"/>
      <category render="true" symbol="7" value="IMS" label="IMS"/>
      <category render="true" symbol="8" value="ISR" label="ISR"/>
      <category render="true" symbol="9" value="LD" label="LD"/>
      <category render="true" symbol="10" value="MrD" label="MrD"/>
      <category render="true" symbol="11" value="MxD" label="MxD"/>
      <category render="true" symbol="12" value="SB" label="SB"/>
      <category render="true" symbol="13" value="SD" label="SD"/>
      <category render="true" symbol="14" value="SSR" label="SSR"/>
      <category render="true" symbol="15" value="TG" label="TG"/>
      <category render="true" symbol="16" value="WB" label="WB"/>
      <category render="false" symbol="17" value="" label=""/>
    </categories>
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="102,99,203,255"/>
      ...
      <symbol alpha="1" type="fill" name="13">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="205,195,222,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="244,217,190,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
