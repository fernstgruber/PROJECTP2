---
title: "profilepoint analysis siliceous bedrock"
...
boxplot(data=relevantmodeldata[c("TRI_hr_ws43",dependent)],as.formula(paste("TRI_hr_ws43","~ ", dependent,sep=" ")),outline=T,main="TRI_hr_ws43")
```
...
boxplot(data=relevantmodeldata[c(as.character(rownames(roughimp)[1]),"SGU_kartiert")],as.formula(paste(as.character(rownames(roughimp)[1]),"~ ", dependent,sep=" ")),outline=F,main=as.character(rownames(roughimp)[1]))
boxplot(data=relevantmodeldata[c(as.character(rownames(localimp)[1]),"SGU_kartiert")],as.formula(paste(as.character(rownames(localimp)[1]),"~ ", dependent,sep=" ")),outline=T,main=as.character(rownames(localimp)[1]))
boxplot(data=relevantmodeldata[c("geom_hr_L3_fl1_rplippatchdensity_UE_hr_5cells_hr",dependent)],as.formula(paste("geom_hr_L3_fl1_rplippatchdensity_UE_hr_5cells_hr","~ ", dependent,sep=" ")),outline=T,main="geom_hr_L3_fl1_rplippatchdensity_UE_hr_5cells_hr")
```
