---
title: "profilepoint analysis Slope deposits"
...
what are the units with the most confusion?
DC  20
CSR 13
CBD 8
Mxd 6
...
For instance different to Debris cones
...
boxplot(data=relevantmodeldata[c("geom_hr_L3_fl10_rplipedgedensity_UE_hr_20cells_hr",dependent)],as.formula(paste("geom_hr_L3_fl10_rplipedgedensity_UE_hr_20cells_hr","~ ", dependent,sep=" ")),outline=T,main="geom_hr_L3_fl10_rplipedgedensity_UE_hr_20cells_hr")
```
...
How about calcareous sedimentary rock
...
How about siliceous sedimentary rock
