...
origmodeldata[origmodeldata$SGU_kartiert == "SD","SDornot"] <- "slopedeposits"
origmodeldata[origmodeldata$SGU_kartiert != "SD","SDornot"] <- "notslopedeposits"
origmodeldata$SDornot <- as.factor(origmodeldata$SDornot)
dependent="SDornot"
#########################################################################################
psets <- c(5)
...
for (p in paramsets){
  ...
  mydir=paste("ranfor_",dependent,"_mitSGUgk_",predset_name,"",sep="")
  dir.create(mydir)
  #############################################################################################################################
  #############################################################################################################################
  k=5
