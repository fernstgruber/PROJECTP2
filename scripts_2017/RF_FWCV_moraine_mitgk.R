...
origmodeldata[origmodeldata$SGU_kartiert == "TG","tillornot"] <- "till"
origmodeldata[origmodeldata$SGU_kartiert != "TG","tillornot"] <- "nottill"
origmodeldata$tillornot <- as.factor(origmodeldata$tillornot)
dependent="tillornot"
#########################################################################################
psets <- c(3)
