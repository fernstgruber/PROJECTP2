...
save(sampledata,localterrain,regionalterrain,roughness,heights,file="/media/fabs/Volume/01_PAPERZEUG/paper2data/sampledata_100mgrid.RData")
...
save(profiledata,localterrain,regionalterrain,roughness,heights,file="/media/fabs/Volume/01_PAPERZEUG/paper2data/profiledata.RData")
