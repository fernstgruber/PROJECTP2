...
origmodeldata[origmodeldata$SGU_kartiert == "TG","till"] <- "kart"
origmodeldata[origmodeldata$SGU_gk == "TG","till"] <- "gk"
origmodeldata<-origmodeldata[!(is.na(origmodeldata$till)),]
origmodeldata$till <- as.factor(origmodeldata$till)
dependent="till"
#########################################################################################
psets <- c(3)
...
for (p in paramsets){
  ...
  mydir=paste("ranfor_",dependent,"_",predset_name,"",sep="")
  dir.create(mydir)
  #############################################################################################################################
  #############################################################################################################################
  k=3
